...
const MUTATING_TOOLS = new Set<string>([...WRITE_TOOLS, TOOL_NAMES.MEMORY_WRITE, TOOL_NAMES.MEMORY_DELETE, TOOL_NAMES.SHELL, TOOL_NAMES.SHELL_START, TOOL_NAMES.SHELL_PTY_START, TOOL_NAMES.SHELL_SEND, TOOL_NAMES.SHELL_RESIZE, TOOL_NAMES.SHELL_STOP])
